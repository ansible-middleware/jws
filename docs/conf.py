...
project = 'JWS Ansible Collection'
...
htmlhelp_basename = 'JWSCollectionDoc'
...
latex_documents = [
    (master_doc, 'JWSCollection.tex', 'Red Hat JWS Ansible Collection Documentation',
     'Red Hat, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'jwscollection', 'Red Hat JWS Ansible Collection Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'JWSCollection', 'Red Hat JWS Ansible Collection Documentation',
     author, 'JWSCollection', 'One line description of project.',
     'Miscellaneous'),
]
